...
- AI for interactive and immersive environments
- AR applications connected with computer vision
- Better structure, documentation, and presentation for ML/AR projects
- Building projects that are both technical and portfolio-ready

---

## Goals

- Build stronger end-to-end AI and AR projects
- Improve project quality through better documentation and organization
- Connect software engineering fundamentals with practical AI applications

---

## Contact

- GitHub: [@LuciTa81](https://github.com/LuciTa81)
- Email: freshsky8217@gmail.com
